...
public class JobGUI extends JFrame {
    ...
    private JTextField txtTodoList;  // You might consider removing this if unused; keeping for now as per your code
    ...
    private void initComponents() {
        ...
        // Save, Reset, Close (added only in edit mode)
        // btnSave = new JButton("Save");
        // btnSave.setBounds(480, 115, 120, 29);
        // btnSave.addActionListener(e -> saveChanges());

        btnReset = new JButton("Reset");
        btnReset.setBounds(480, 155, 120, 29);
        btnReset.addActionListener(e -> populateFieldsFromJob(job));

        btnClose = new JButton("Cancel");
        btnClose.setBounds(480, 195, 120, 29);
...
//     private JTextField txtTodoListInput;        
//     private JList<String> todoJList;               
//     private JLabel lblCompany, lblRole, lblStatus, lblSalary, lblLocation;
...
//         for (Task task : job.getTodoList().getAllTasks()) {
//             todoListModel.addElement(task.toString());
//             txtTodoList.append(task.toString() + "\n");
//         }
//     }
